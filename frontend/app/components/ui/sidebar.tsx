...
export function SidebarMenuButton({
  ...
  const defaultProps = {
    className: cn(
      "flex w-full items-center gap-2 rounded-md p-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-foreground [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
