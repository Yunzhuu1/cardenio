...
understanding, character profile, outline, and screenplay generation routes now
delegate through `domain service -> stage agent -> ControlledAgent -> LLM gateway`,
while preserving the existing HTTP API response shape.
